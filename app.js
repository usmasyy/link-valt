class LinkManager {
    ...
    constructor() {
        this.links = JSON.parse(localStorage.getItem('links')) || this.getDefaultLinks();
    ...
    getDefaultLinks() {
        return [{
            id: 1,
            url: "https://www.nature.com/articles/s41598-019-47943-6",
            ...
            tags: ["tuberculosis", "research", "scientific-paper", "drug-resistance"],
            timestamp: new Date("2019-08-06").toISOString()
        }];
    }
    setupEventListeners() {
